...
impl AppConfig {
    pub fn load() -> Result<Self> {
        let builder = Config::builder()
            ...
            .set_override_option(
                "llm_llama_service_grpc_url",
                env::var("LLM_LLAMA_SERVICE_GRPC_URL").ok(),
            )?
            // DEFAULTS
            ...
            .set_default(
                "llm_llama_service_grpc_url",
                "https://llm-llama-service:16071",
            )?
            .set_default("grpc_tls_ca_path", "/sentiric-certificates/certs/ca.crt")?
            .set_default(
                "llm_gateway_service_cert_path",
                "/sentiric-certificates/certs/llm-gateway-service.crt",
            )?
            .set_default(
                "llm_gateway_service_key_path",
                "/sentiric-certificates/certs/llm-gateway-service.key",
            )?;
